...
\begin{tikzpicture}[remember picture, overlay] 
  \node[anchor = south,fill=CVBlue,draw=none,minimum width=\paperwidth,minimum height=1.5em,align=center,font=\footnotesize,text=white] at ($(current page.south)$) {\linkedin{https://www.linkedin.com/in/ryushane} \qquad \github{https://github.com/ryushane} \qquad \homepage{https://ryushane.com}};
\end{tikzpicture}%
...
\section{\texorpdfstring{\faGraduationCap}{} 教育背景}  % texorpdfstring是为了消除token not allowed in a PDF string的警报，在section中想插入特殊符号需要
